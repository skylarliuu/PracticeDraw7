    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PropertyValuesHolder valuesHolder = PropertyValuesHolder.ofKeyframe("progress",
                        keyframe1,keyframe2,keyframe3);
                // 使用 ObjectAnimator.ofPropertyValuesHolder() 来创建动画
                ObjectAnimator objectAnimator = ObjectAnimator.ofPropertyValuesHolder(view,valuesHolder);
